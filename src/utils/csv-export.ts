...
function leadsToRows(leads: Lead[]): ExportRow[] {
...
export function exportLeadsToCSV(options: ExportOptions = {}): string {
...
export function exportLeadsAsJSON(options: ExportOptions = {}): object[] {
