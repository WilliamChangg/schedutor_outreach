            ...
            switch (_t.label) {
                case 0:
                    ...
                    switch (_a) {
                        ...
                        case 'export': return [3 /*break*/, 35];
                        case 'dashboard': return [3 /*break*/, 36];
                        case 'stats': return [3 /*break*/, 37];
                        case 'list': return [3 /*break*/, 38];
                        case 'help': return [3 /*break*/, 39];
                    }
                    return [3 /*break*/, 39];
                case 1:
                ...
                case 3:
                    ...
                    country = (((_s = argsWithoutFlags[1]) === null || _s === void 0 ? void 0 : _s.toUpperCase()) || 'US');
                ...
                case 37:
                    {
                        ...
                        console.log('\nBy Pipeline Stage:');
                        for (_k = 0, _l = Object.entries(stats.byPipelineStage); _k < _l.length; _k++) {
                            _m = _l[_k], stage = _m[0], count = _m[1];
                            console.log("  ".concat(stage, ": ").concat(count));
                        }
                        console.log('\nBy Source:');
                        for (_o = 0, _p = Object.entries(stats.bySource); _o < _p.length; _o++) {
                            _q = _p[_o], source = _q[0], count = _q[1];
                ...
                case 38:
                    {
                        ...
                        for (_r = 0, leads_1 = leads; _r < leads_1.length; _r++) {
                            lead = leads_1[_r];
